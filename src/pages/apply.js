      ...
      <div className='apply'>
        <div className={`${this.state.hide}`}>
          ...
          <div className='form'>
            ...
            <hr/>
            <p>The Stop KM Legal Defence Fund grants financial assistance to cover legal defence costs stemming from
protest, civil disobedience, and direct action activities in opposition to the Kinder Morgan Trans Mountain pipeline
...
providing all required information and provide supporting documentation. If you are a lawyer applying to the Stop
KM Legal Defence Fund, please work with your client to complete the application below.
...
defendants. The purpose of the Stop KM Legal Defence Fund is to put solidarity into action. As such, particular
...
<p><strong>Note:</strong> Although the Stop KM Legal Defence Fund wishes it had the ability to fund the legal costs of all those who
